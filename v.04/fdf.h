...
typedef struct s_mlx//estructura para la mlx
{
	...
	int		line_length;
	int		endian;
	int		size_x;//limite x de la imagen
	int		size_y;//limite y de la imagen
	int		esc;//escala
}	t_mlx;
...
void	ft_line_ppx_c(t_mlx *gr, t_num *num, t_str *str);//función que calcula los puntos de la linea para la caballera
void	ft_line_ppy_c(t_mlx *gr, t_num *num, t_str *str);//, t_str *str);//función que calcula los puntos de la linea para la caballera
