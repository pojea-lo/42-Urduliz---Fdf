...
/*   Updated: 2022/02/08 14:21:52 by pojea-lo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
double	ft_wde_size(double *size)//funcion que saca el valor de la escala en función del size min necesario y una ventana estándar de 2000x1000
{
	double		escx;
	double		escy;
	double		esc;
